...
export interface OperationalKpis { census: number; physicalBeds: number; staffedBeds: number; actionableBeds: number; expectedDischarges: number; expectedArrivals: number; edHolds: number; pendingTransfers: number; capacityStatus: CapacityStatus; projectedCensus: number; projectedDelta: number; }
